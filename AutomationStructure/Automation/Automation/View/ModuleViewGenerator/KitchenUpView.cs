...
namespace Automation.View.ModuleViewGenerator
{
    ...
    public class KitchenUpView : ViewGenerator
    {
        ...
        private ColumnGroupsViewDefinition SetColumnGroupsView()
        {
            ...
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Номер модуля");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            //view.ColumnGroups.Add(new GridViewColumnGroup("F"));
            //view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            //view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Форма модуля");
            //view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            view.ColumnGroups.Add(new GridViewColumnGroup("I"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Icon");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;


            view.ColumnGroups.Add(new GridViewColumnGroup("Размеры"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Высота модуля (мм)");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Ширина модуля (мм)");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Глубина модуля (мм)");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("A размер (мм)");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("B размер (мм)");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("C размер (мм)");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("D размер (мм)");


            view.ColumnGroups.Add(new GridViewColumnGroup("zertg"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Сборка модуля2");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            view.ColumnGroups.Add(new GridViewColumnGroup("z"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Задняя стенка2");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            view.ColumnGroups.Add(new GridViewColumnGroup("ppse"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Крепление полки");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Кол-во полок");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            view.ColumnGroups.Add(new GridViewColumnGroup("Фасад"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("№ схемы фасада");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Высота");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Ширина");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Тип фасада2");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Режим расчёта2");
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Материал фасада2");

            view.ColumnGroups.Add(new GridViewColumnGroup("ПОСУДОСУШИЛКА"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("ПОСУДОСУШИЛКА2");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;

            view.ColumnGroups.Add(new GridViewColumnGroup("Навесы на стену"));
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows.Add(new GridViewColumnGroupRow());
            view.ColumnGroups[view.ColumnGroups.Count - 1].Rows[0].ColumnNames.Add("Навесы на стену2");
            view.ColumnGroups[view.ColumnGroups.Count - 1].ShowHeader = false;
